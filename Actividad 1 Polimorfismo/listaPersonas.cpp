...
int main() {
    ...
    for (int c = 0; c < cantPersonas; c++)
    {
        ...
        if (opcionPersona == 'a') {
            ...
            cin >> carrera;
            arreglo[c] = new Estudiante(nombre,edad,carrera);            
            ...
            cin >> departamento;
            arreglo[c] = new Maestro(nombre, edad, departamento);
            ...
            arreglo[c] = new Persona(nombre,edad);
    ...
    do
    {
        ...
        switch (opcionMenu) {
            ...
            case 'b':  {
                ...
                // Recuerda cada persona tiene que mostrarse usando su propia version del muestraDatos
                for (int i = 0; i<cantPersonas;i++){
                    if (arreglo[i]->getEdad() >= edadIni && arreglo[i]->getEdad() <= edadFin){
                        arreglo[i]->muestraDatos();
                    }
                }
