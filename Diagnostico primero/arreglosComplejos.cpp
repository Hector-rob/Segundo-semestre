...
void pruebaOperaciones(){
    ...
    //c1.multiplicacion(c2).imprime();
    //multi = c1.multiplicacion(c2);
   // multi.imprime();
    ...
    //c1.multiEscalar(3.5).imprime();
    escalar = c1.multiEscalar(3.5);
    //escalar.imprime();
    //6. Crea el complejo llamado escalar y asígnale el resultado de la multiplicación escalar de c1 por 3.5
