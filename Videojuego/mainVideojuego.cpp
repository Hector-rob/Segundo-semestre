...
//MANEJO EXCEPCIONES
char excepcion(char opcion){
    if(opcion != 'a' && opcion!= 'A' && opcion != 'b' && opcion !='B' && opcion != 'c' && opcion!= 'C' ){
        throw "Lo que ingresaste no es válido. Solo puedes contestar a,b o c";
    }
    else{
        return opcion;
    }
...
char excepcion1(char opcion){
    if(opcion != 'a' && opcion!= 'A' && opcion != 'b' && opcion !='B'){
        throw "Lo que ingresaste no es válido. Solo puedes contestar a o b";
    }
    else{
        return opcion;
    }
...
char excepcion2(char opcion){
    if(opcion != 'a' && opcion!= 'A'){
        throw "Lo que ingresaste no es válido. Solo puedes contestar con la letra a";
    }
    else{
        return opcion;
    }
...
int main(){
    ...
    cout << "Para elegir, introduce la letra de la opción deseada." << endl;
    ...
    Alejandra.imprimeP();
    cout << endl;
    cout <<"Personajes secundarios:" << endl;
    ...
    cout << "a) Te subes a dormir" << endl;
    cout <<"b) Te da hambre y decides desayunar unos fabulosos Choco Krispis con mucha leche" << endl;
    cout << "c) Te diriges al hospital para investigar y aprovechas para ver a tu novio" << endl << endl;
    char opcion1;
    while(opcion1 != 'a' && opcion1!= 'A' && opcion1 != 'b' && opcion1 !='B' && opcion1 != 'c' && opcion1!= 'C'){
        cin >> opcion1;
            try{
            opcion1 = excepcion(opcion1);
                if(opcion1 != 'a' && opcion1!= 'A' && opcion1 != 'b' && opcion1 !='B' && opcion1 != 'c' && opcion1!= 'C'){
                    break;
                }
        }
    ...
    switch(opcion1){
        ...
        cout << "Recorres el hospital, caminas bastante pero finalmente llegas a dicha sala." << endl << endl;
        cout << "¿Qué haces?" << endl;
        break;
        }
        case 'c':{
    ...
    bool morrito = false;
    cout << endl;
    cout << "a) Ves a un niño solo y asustado. Decides ir a hablar con él." << endl;
    cout << "b) En la mesita de la sala de espera ves una revista que habla de la nueva película de Shrek y te pones a leerla." << endl;
    cout << "c) Decides revisar las batas para ver si está la de tu novio o si está en alguna operación." << endl << endl;
    char opcion2;
    while(opcion2 != 'a' && opcion2!= 'A' && opcion2 != 'b' && opcion2 !='B' && opcion2 != 'c' && opcion2!= 'C'){
        cin >> opcion2;
            try{
            opcion2 = excepcion(opcion2);
                if(opcion2 != 'a' && opcion2!= 'A' && opcion2 != 'b' && opcion2 !='B' && opcion2 != 'c' && opcion2!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    cout << "Regresas al presente. Te resulta peculiar, ya que no recuerdas haber tenido un problema en el corazón. Tu instinto te dice que agarres la bata." << endl << endl;
    cout << "¿Qué haces?" << endl;
    // OPCIONES ESCENARIO 3
    cout << endl;
    cout << "a) Decides ir al consultorio de la doctora Fiji para saber más al respecto." << endl;
    cout << "b) En la televisión comienza a salir el programa de los Backyardigans y te llega una sensación que nunca antes habías experimentado. Te quedas a verlo." << endl;
    cout << "c) Decides volver a tu casa" << endl << endl;
    char opcion3;
    while(opcion3 != 'a' && opcion3!= 'A' && opcion3 != 'b' && opcion3 !='B' && opcion3 != 'c' && opcion3!= 'C'){
        cin >> opcion3;
            try{
            opcion3 = excepcion(opcion3);
                if(opcion3 != 'a' && opcion3!= 'A' && opcion3 != 'b' && opcion3 !='B' && opcion3 != 'c' && opcion3!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    while (respuesta != 'S' && respuesta !='s'){
      if(respuesta == 'N' || respuesta =='n'){
        ...
        cout << "¿Inspeccionas la bata?  (S/N)" << endl;
        cin >> respuesta;
      }
      else{
    ...
    cout << "logros de la doctora así como de sus diplomas. Notas que en la mesa tiene algunos expedientes con fotos." << endl << endl;
    cout << "¿Qué haces?" << endl;
    // OPCIONES ESCENARIO 4
    cout << endl;
    cout << "a) Revisas expediente 1." << endl;
    cout << "b) Revisas expediente 2." << endl;
    cout << "c) Revisas libreta con apuntes." << endl << endl;
    char opcion4;
    while(opcion4 != 'a' && opcion4!= 'A' && opcion4 != 'b' && opcion4 !='B' && opcion4 != 'c' && opcion4!= 'C'){
        cin >> opcion4;
            try{
            opcion4 = excepcion(opcion4);
                if(opcion4 != 'a' && opcion4!= 'A' && opcion4 != 'b' && opcion4 !='B' && opcion4 != 'c' && opcion4!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    switch(opcion4){
        ...
        cout << "Al parecer te iban a operar en el quirófano número 3. Tomas tu expediente y te llega una sensación de que debes dirigirte al quirófano." << endl;
        ...
        cout << endl;
        cout << "¿Qué haces?" << endl;
        cout << "a) Revisas expediente 2." << endl;
        cout << "b) Revisas libreta con apuntes." << endl << endl;
        char o;
        while(o != 'a' && o!= 'A' && o != 'b' && o !='B'){
        cin >> o;
            try{
            o = excepcion1(o);
                if(o != 'a' && o!= 'A' && o != 'b' && o !='B'){
        ...
        switch(o){
            ...
            cout << "¿Que haces?" << endl;
            cout << "a) Revisas libreta con apuntes." << endl << endl;
            char op;
             while(op != 'a' && op!= 'A'){
                cin >> op;
                try{
                ...
                cout << "Sientes los celos recorriendo tu cuerpo. " << endl << endl;
                cout << "¿Que haces?" << endl;
                cout << "a) Revisas expediente 2." << endl << endl;
                char opc;
                while(opc != 'a' && opc!= 'A'){
                    cin >> opc;
                    try{
        ...
        switch(o){
            ...
            char op;
             while(op != 'a' && op !='A'){
                ...
                cout << "Sientes los celos recorriendo tu cuerpo. " << endl << endl;
                cout << "¿Que haces?" << endl;
                cout << "a) Revisas expediente 1." << endl << endl;
                char opc;
                while(opc != 'a' && opc != 'A'){
                    cin >> opc;
                    try{
        ...
        cout << "¿Qué haces" << endl;
        cout << "a) Revisas expediente 1." << endl;
        cout << "b) Revisas expediente 2." << endl << endl;
        char o;
        while(o != 'a' && o!= 'A' && o!= 'b' && o!='B'){
        cin >> o;
            try{
    ...
    cout <<endl << "¿Qué haces?" << endl;
    // OPCIONES ESCENARIO 5
    cout << endl;
    cout << "a) Te diriges al quirófano." << endl;
    cout << "b) Te asustas y decides irte a casa." << endl;
    cout << "c) Dibujas un diagrama UML en los apuntes de la doctora como te enseño Fabiola." << endl << endl;
    char opcion5;
    while(opcion5 != 'a' && opcion5!= 'A' && opcion5 != 'b' && opcion5 !='B' && opcion5 != 'c' && opcion5!= 'C'){
        cin >> opcion5;
            try{
            opcion5 = excepcion(opcion5);
                if(opcion5 != 'a' && opcion5!= 'A' && opcion5!= 'b' && opcion5 !='B' && opcion5 != 'c' && opcion5!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    cout << endl;
    cout << "a) Investigas el quirófano." << endl;
    cout << "b) Ves sangre en el piso, te asqueas y decides irte a casa." << endl;
    cout << "c) Ves una cucaracha en el piso y quieres matarla." << endl << endl;
    char opcion6;
    while(opcion6 != 'a' && opcion6!= 'A' && opcion6!= 'b' && opcion6 !='B' && opcion6!= 'c' && opcion6!= 'C'){
        cin >> opcion6;
            try{
            opcion6 = excepcion(opcion6);
                if(opcion6 != 'a' && opcion6!= 'A' && opcion6 != 'b' && opcion6 !='B' && opcion6 != 'c' && opcion6!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    cout << endl;
    cout << "a) Como el quirófano está muy sucio, decides limpiarlo." << endl;
    cout << "b) Te dan ganas de dormir una siesta por lo que te regresas a tu casa" << endl;
    cout << "c) Decides volver al consultorio de la Dra.Fiji para investigar más" << endl << endl;
    char opcion7;
    while(opcion7 != 'a' && opcion7!= 'A' && opcion7 != 'b' && opcion7 !='B' && opcion7 != 'c' && opcion7!= 'C'){
        cin >> opcion7;
            try{
            opcion7 = excepcion(opcion7);
                if(opcion7 != 'a' && opcion7!= 'A' && opcion7 != 'b' && opcion7 !='B' && opcion7 != 'c' && opcion7!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
    ...
    cout << "sostiene la foto de un cádaver. Te quedas inmóvil, es una foto de TU cádaver." << endl;
    ...
    cout << endl;
    cout << "¿Qué haces?" << endl;
    cout << "a) Aceptas tu muerte y abandonas este mundo" << endl;
    cout << "b) Te da igual y decides ponerte a asustar personas" << endl;
    cout << "c) Decides intentar exponer los actos de la Dra.Fiji" << endl << endl;
    char opcion8;
    while(opcion8 != 'a' && opcion8!= 'A' && opcion8 != 'b' && opcion8 !='B' && opcion8 != 'c' && opcion8!= 'C'){
        cin >> opcion8;
            try{
            opcion8 = excepcion(opcion8);
                if(opcion8 != 'a' && opcion8!= 'A' && opcion8 != 'b' && opcion8 !='B' && opcion8 != 'c' && opcion8!= 'C'){
                    break;
                }
        }
        catch(const char* msg){
